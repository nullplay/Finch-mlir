//===- finch-cap-demo.c - Simple demo of C-API -----------------------===//
//
...
// RUN: finch-capi-test 2>&1 | FileCheck %s
...
int main(int argc, char **argv) {
  ...
  // This adds dozens of MB of binary size over just the finch dialect.
  registerAllUpstreamDialects(ctx);
  mlirDialectHandleRegisterDialect(mlirGetDialectHandle__finch__(), ctx);
